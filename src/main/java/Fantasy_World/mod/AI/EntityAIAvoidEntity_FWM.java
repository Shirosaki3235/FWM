...
public class EntityAIAvoidEntity_FWM extends EntityAIBase
{
    public final IEntitySelector field_98218_a = new IEntitySelector()
    {
        ...
        {
            return p_82704_1_.isEntityAlive() && EntityAIAvoidEntity_FWM.this.theEntity.getEntitySenses().canSee(p_82704_1_);
        }
    };
    ...
    public EntityAIAvoidEntity_FWM(EntityCreature p_i1616_1_, Class p_i1616_2_, float p_i1616_3_, double p_i1616_4_, double p_i1616_6_)
    {
