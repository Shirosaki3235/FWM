...
public class magic_forest_chunkmanager extends WorldChunkManager{
    ...
    protected magic_forest_chunkmanager() {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList();
        this.biomesToSpawnIn.addAll(allowedBiomes);
    }

    public magic_forest_chunkmanager(long par1, WorldType par3WorldType) {
        this();
    ...
    public magic_forest_chunkmanager(World par1World) {
