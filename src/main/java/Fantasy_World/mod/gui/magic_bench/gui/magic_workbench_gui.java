package Fantasy_World.mod.gui.magic_bench.gui;
...
public class magic_workbench_gui extends GuiContainer {

	private magic_workbench_tileentity tileEntity;
	...
	public magic_workbench_gui(EntityPlayer player, magic_workbench_tileentity tileEnttiy) {
		super(new magic_workbench_container(player, tileEnttiy));
