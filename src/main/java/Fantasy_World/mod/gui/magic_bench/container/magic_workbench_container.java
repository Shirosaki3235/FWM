package Fantasy_World.mod.gui.magic_bench.container;
...
public class magic_workbench_container extends Container {
	...
	public magic_workbench_container(EntityPlayer player, magic_workbench_tileentity tileEntity) {
		// スロットを設定する。
