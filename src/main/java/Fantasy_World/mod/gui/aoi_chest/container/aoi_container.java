package Fantasy_World.mod.gui.aoi_chest.container;
...
public class aoi_container extends Container {
	...
	public aoi_container(EntityPlayer player, aoi_tileentity tileEntity) {
		// スロットを設定する。
